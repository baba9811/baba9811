...
- **[i-am-bee/beeai-framework](https://github.com/i-am-bee/beeai-framework)**: Fixed incorrect GrepTool search results for leading-hyphen patterns by separating ripgrep options from search arguments. ([PR #1660](https://github.com/i-am-bee/beeai-framework/pull/1660))
